...
type SysDictionaryDetail struct {
	...
	SysDictionaryID int    `json:"sysDictionaryID" form:"sysDictionaryID" gorm:"column:supplier_sys_dictionary_id;comment:关联标记"` // 关联标记
}

func (SysDictionaryDetail) TableName() string {
	return "supplier_sys_dictionary_details"
}
